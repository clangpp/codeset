...
//  2. If x to y has odd number edges (n1, n2, n3, ..., nt), then x+y is determined as n1-n2+n3-...+nt.
//  3. If there's evidence z+z=n, then z is determined (n/2), and thus all nodes connected with z are determined.
//    But no need for determination, one path of (n1, n2, ..., nz, ..., nt) and (n1, n2, ..., nz, n(z-to-z), ... nt) must has odd number edges, then x+y can be determined by rule 2.
//  4. If there's circle (z to z) which has odd number edges (n1, n2, n3, ..., nt), then z is determined as (n1-n2+n3-...+nt)/2, thus all nodes connected with z are determined.
//    But no need for determination, one path of (n1, n2, ..., nz, ..., nt) and (n1, n2, ..., nz, n(z-to-circle1), ..., n(circle-1-to-z), ..., nt) must has odd number edges, then x+y can be determined by rule 2.
