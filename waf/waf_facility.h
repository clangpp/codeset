...
class FreqVector {
 ...
 private:
  ...
  class basic_iterator
   ...
   public:  // constructors
    friend class FreqVector::iterator;
    friend class FreqVector::const_iterator;
 ...
 public:
  ...
  class iterator : public basic_iterator<FreqVector*> {
   ...
   public:
    ...
    size_type& operator[](difference_type n) { return *iterator(*this + n); }
 ...
 public:  // serialization
  ...
  friend std::ostream& operator<<(std::ostream& os, const FreqVector& freqvec);
